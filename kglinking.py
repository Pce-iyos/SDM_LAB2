...
tbox_path = './DATA/kgtbox.ttl'
abox_path = './DATA/abox_result.ttl'
output_path = './DATA/combined_graph_test.ttl'
...
combined_graph.parse('./DATA/combined_graph_test.ttl', format='turtle')
